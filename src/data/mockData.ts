...
export const mockTeams: Team[] = [
  {
    ...
    description: 'A tactical team focused on stealth and precision in urban environments.',
  ...
  },
  {
    ...
    description: 'Specializing in forest operations and long-range engagements.',
  ...
  },
  {
    id: 'team-3',
    name: 'Desert Foxes',
    description: 'Experts in arid environment operations and quick tactical responses.',
...
export const mockMarketplaceItems: MarketplaceItem[] = [
  {
    ...
    condition: 'Good',
    category: 'Guns',
    images: ['https://images.pexels.com/photos/313395/pexels-photo-313395.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'],
    seller: mockUsers[0],
