...
const ItemDetails: React.FC = () => {
  ...
  const timeAgo = formatDistance(new Date(item.created_at), new Date(), {
    addSuffix: true,
  });
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
            ...
            <div>
              ...
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">
                    Member since{" "}
                    {new Date(item.seller.created_at).toLocaleDateString()}
                  </p>
                </div>
              </div>
              ...
              {authState.isAuthenticated ? (
                ...
                <Link to="/login">
                  <Button leftIcon={<User className="h-5 w-5" />}>
