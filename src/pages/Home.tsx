    ...
    <div className="flex flex-col">
      ...
      <section className="relative">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.pexels.com/photos/4753879/pexels-photo-4753879.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')",
          }}
        ></div>
        <div className="absolute inset-0 flex flex-col items-center justify-center z-20 p-4">
          ...
          <p className="text-white text-xl md:text-2xl text-center max-w-3xl mb-8 animate-fadeIn animation-delay-300">
            Connect with teams, join events, and find the perfect gear for your
            next game.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center p-6 rounded-lg border border-gray-100 hover:shadow-md transition-shadow duration-300">
              ...
              <p className="text-gray-600">
                Browse and join upcoming airsoft events hosted by teams across
                the country. Create and manage your own events as a team.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center p-6 rounded-lg border border-gray-100 hover:shadow-md transition-shadow duration-300">
              ...
              <p className="text-gray-600">
                Buy, sell, or trade airsoft gear with other enthusiasts. List
                your equipment and connect with potential buyers.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center p-6 rounded-lg border border-gray-100 hover:shadow-md transition-shadow duration-300">
              ...
              <p className="text-gray-600">
                Create or join teams, coordinate with teammates, and organize
                your airsoft activities together.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-slate-900 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Create an account to participate in events, list your gear, and
            connect with the airsoft community.
          </p>
